...
-- VINCULANDO OS CURSOS QUE PRECISAM DE OUTROS CURSOS PARA SEREM ESTUDAOS
ALTER TABLE CURSOS ADD CONSTRAINT FK_PREREQ
FOREIGN KEY(ID_PREREQ) REFERENCES CURSOS(IDCURSO);

INSERT INTO CURSOS VALUES(NULL,'BD RELACIONAL',20,400.00,NULL);

-- NESSES DOIS CURSOS PODEMOS VER QUE EXISTE UM PRÉ-REQUISITO PARA SER LECIONADO, DADO PELO ÚLTIMO VALOR.
...
-- AQUI UMA FORMA ELEGANTE DE EXIBIR NA TELA OS DADOS DA TABELA
SELECT
C.NOME AS CURSO, 
C.VALOR AS VALOR, 
C.HORAS AS CARGA, 
